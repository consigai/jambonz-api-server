...
class EcrRepositoryStack(cdk.Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        repository = ecr.Repository(self,
                       "ConsigjambonzApiServerRepo",
                       repository_name="consig-jambonz-api-server")

        jambonzApiServer_image_asset = ecr_assets.DockerImageAsset(self, "jambonzApiServer",
        ...
        ecrdeploy.ECRDeployment(self, f"DeployDockerImageSHA_{github_sha}",
                      src=ecrdeploy.DockerImageName(jambonzApiServer_image_asset.image_uri),
...
# Create Docker Repo
#
EcrRepositoryStack(app, "jambonzApiServer")
